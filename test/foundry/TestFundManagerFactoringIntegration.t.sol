...
contract TestFundManagerFactoringIntegration is CommonSetup {
    ...
    function testCapitalCall_TriggersFactoringCapability() public {
        ...
        vm.prank(bob);
        vm.expectRevert(abi.encodeWithSelector(BullaFactoringV2.InsufficientFunds.selector, 0, 63243856000)); // Should fail due to insufficient funds (0 available, net funded amount required)
